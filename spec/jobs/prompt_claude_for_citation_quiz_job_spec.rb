      ...
      context "success_response" do
        ...
        context "claude_admin_submission" do
          ...
          it "updates the quiz" do
            ...
            expect(instance.quiz_prompt_full_texts(citation, quiz.prompt_text)).to eq(["some prompt, article: some text"])
  ...
  describe "prompts_full_text" do
    ...
    context "with quiz" do
      ...
      it "allows multiple texts" do
        ...
        expect(instance.quiz_prompt_full_texts(citation, prompt_text)).to eq target_first
      end
