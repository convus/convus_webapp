...
RSpec.describe VoteScoreUpdater do
  ...
  describe "normalize_score_hash" do
    let(:normalized) do
      {
        required: {"166"=> 15, "69"=> 14},
        constructive: {"70"=> 3, "131"=> 2, "169"=> 1},
        not_recommended: {"105"=> -1, "198"=> -2}
      }
    end
    ...
    context "only required, no constructive" do
      let(:normalized) do
        {
          required: {"166"=> 15, "69"=> 14, "70"=> 13, "131"=> 12, "169"=> 11},
          constructive: {},
          not_recommended: {"105"=> -1, "198"=> -2}
        }
      end
  ...
  describe "update" do
    ...
    let(:initial_score_hash) do
      {
        required: {vote_required1.id.to_s => 12, vote_required2.id.to_s => 11},
        constructive: {vote_constructive.id.to_s => 1},
        not_recommended: {vote_not_recommended.id.to_s => -1}
      }
    end
