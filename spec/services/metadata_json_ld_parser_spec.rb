...
RSpec.describe MetadataJsonLdParser do
  ...
  describe "parse" do
    ...
    context "thoughtco" do
      let(:citation_metadata_str) { '[{"name":"description","content":"Farm subsidies are considered a prime area for budget cutbacks, but these are opposed by powerful farm lobbyists and members of Congress.","itemprop":"description"},{"name":"emailcontenttype","content":"STRUCTUREDCONTENT"},{"name":"emailvertical","content":"THOUGHTCO"},{"name":"sailthru.author","content":"Deborah White"},{"name":"sailthru.tags","content":"humanities,issues,us-liberal-politics"},{"name":"parsely-section","content":"Humanities"},{"name":"parsely-tags","content":"Humanities,Issues,U.S. Liberal Politics"},{"content":"What Are U.S. Farm Subsidies?","itemprop":"name"},{"content":"ThoughtCo","property":"article:section"},{"content":"article","property":"og:type"},{"content":"ThoughtCo","property":"og:site_name"},{"content":"https://www.thoughtco.com/us-farm-subsidies-3325162","property":"og:url"},{"content":"Are U.S. Farm Subsidies Corporate Welfare or National Necessities?","property":"og:title"},{"content":"Farm subsidies are considered a prime area for budget cutbacks, but these are opposed by powerful farm lobbyists and members of Congress.","property":"og:description"},{"content":"https://www.thoughtco.com/thmb/FhcXSB3C_TgpbD1IFxRY0gcQUmc=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/farmers-association-to-announce-grain-harvest-results-484205688-5c4cfeb3c9e77c0001f32218.jpg","property":"og:image"},{"content":"https://www.facebook.com/thoughtcodotcom/","property":"article:author"},{"name":"twitter:card","content":"summary_large_image"},{"name":"twitter:site","content":"@thoughtcocom"},{"name":"twitter:title","content":"Are U.S. Farm Subsidies Corporate Welfare or National Necessities?"},{"name":"twitter:description","content":"Farm subsidies are considered a prime area for budget cutbacks, but these are opposed by powerful farm lobbyists and members of Congress."},{"name":"twitter:image","content":"https://www.thoughtco.com/thmb/FhcXSB3C_TgpbD1IFxRY0gcQUmc=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/farmers-association-to-announce-grain-harvest-results-484205688-5c4cfeb3c9e77c0001f32218.jpg"},{"word_count":1176},{"json_ld":[{"@type":["Article"],"about":[],"image":{"url":"https://www.thoughtco.com/thmb/FhcXSB3C_TgpbD1IFxRY0gcQUmc=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/farmers-association-to-announce-grain-harvest-results-484205688-5c4cfeb3c9e77c0001f32218.jpg","@type":"ImageObject","width":1500,"height":979},"author":[{"url":"https://www.thoughtco.com/deborah-white-3325009","name":"Deborah White","@type":"Person"}],"@context":"http://schema.org","headline":"What Are U.S. Farm Subsidies?","publisher":{"url":"https://www.thoughtco.com","logo":{"url":"https://www.thoughtco.com/thmb/ruwsr0VaZ-mxBD_vXVdKmhL0sjY=/250x60/filters:no_upscale():max_bytes(150000):strip_icc()/TC_schema_logo_250x60-59af144bd088c00010d45b5f.png","@type":"ImageObject","width":250,"height":60},"name":"ThoughtCo","@type":"Organization","brand":"ThoughtCo","sameAs":["https://www.facebook.com/thoughtcodotcom","https://www.flipboard.com/@thoughtco"],"publishingPrinciples":"https://www.thoughtco.com/about-us-4779650#toc-editorial-guidelines"},"description":"Farm subsidies are considered a prime area for budget cutbacks, but these are opposed by powerful farm lobbyists and members of Congress.","dateModified":"2020-05-29T11:30:59.560-04:00","datePublished":"2011-05-17T18:29:43.000-04:00","mainEntityOfPage":{"@id":"https://www.thoughtco.com/us-farm-subsidies-3325162","@type":["WebPage"],"breadcrumb":{"@type":"BreadcrumbList","itemListElement":[{"item":{"@id":"https://www.thoughtco.com/issues-4133022","name":"Issues"},"@type":"ListItem","position":1},{"item":{"@id":"https://www.thoughtco.com/us-liberal-politics-4133009","name":"U.S. Liberal Politics"},"@type":"ListItem","position":2},{"item":{"@id":"https://www.thoughtco.com/us-farm-subsidies-3325162","name":"What Are U.S. Farm Subsidies?"},"@type":"ListItem","position":3}]}}}]}]' }
      let(:target_keys) { %w[@type about image author @context headline publisher description dateModified datePublished mainEntityOfPage] }
      it "returns target" do
        content_hash = subject.content_hash(citation_metadata_raw)
        expect(content_hash.keys).to eq(%w[Article])

        expect(subject.parse(citation_metadata_raw, content_hash).keys).to match_array(target_keys)
      end
    end
    context "blank" do
